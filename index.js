...
const descriptionString = `We have raised $${totalRaised.toLocaleString()} for ${GAMES_JSON.length} games. Currently, ${numUnfundedGames} games are unfunded. Please consider supporting our amazing games!`;
...
searchBox.addEventListener("keyup", searchGameByName);